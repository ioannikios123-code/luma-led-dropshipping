...
const allProducts = [
  {
    id: 1,
    name: "RGB LED Strip Lights - Premium",
    shortName: "RGB LED Strips",
    price: 29.99,
    originalPrice: 49.99,
    ...
    reviewCount: 2847,
    badge: "Best Seller",
    features: ["16M Colors", "App Control", "Music Sync", "5M Length"],
    isNew: false,
    isPopular: true
  },
  {
    ...
    reviewCount: 1923,
    badge: "Popular",
    features: ["Voice Control", "Dimming", "Energy Efficient", "No Hub"],
    isNew: false,
    isPopular: true
  },
  {
    ...
    features: ["USB Powered", "Game Effects", "Easy Install", "Sound Reactive"],
    isNew: true,
    isPopular: false
  },
  {
    id: 4,
    name: "Professional LED Panel Light",
    shortName: "LED Panel Pro",
    price: 89.99,
    ...
    reviewCount: 892,
    badge: "Professional",
    features: ["Ultra Bright", "Color Temperature", "Remote Control", "Dimming"],
    isNew: false,
    isPopular: false
  },
  {
    id: 5,
    name: "Outdoor LED String Lights",
    shortName: "Outdoor Strings",
    price: 34.99,
    originalPrice: 54.99,
    image: smartBulbImage,
    category: "Outdoor",
    ...
    features: ["Waterproof IP65", "25ft Length", "Smart Control", "Timer"],
    isNew: true,
    isPopular: false
  },
  {
    ...
    features: ["Motion Sensor", "Battery Powered", "Easy Install", "Warm White"],
    isNew: false,
    isPopular: false
  }
];
